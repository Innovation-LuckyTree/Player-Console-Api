...
namespace HP_Player_Console.Filters;
...
public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
{
        ...
        _exceptionHandlers = new Dictionary<Type, Action<ExceptionContext>>
            {
                ...
                { typeof(BadRequestBaseException), HandleBadException },
                { typeof(GameScheduleException), HandleGameScheduleException },
    ...
    private void HandleGameScheduleException(ExceptionContext context)
    {
        var exception = context.Exception as BetException;
    ...
    private void HandleBettingException(ExceptionContext context)
    {
        var exception = context.Exception as BetException;
    ...
    {
        var exception = context.Exception as BadRequestBaseException;
    ...
    private void HandleUnknownException(ExceptionContext context)
    {
        ...
        {
            Value = new { ResponseCode = "500", ErrorMessage = context.Exception.Message }
        };
