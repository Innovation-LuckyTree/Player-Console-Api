...
using HP_Player_Console.Application.Requests.Accounts.Queries.GetUserAccessToken;
...
public class AuthController : ApiBaseController
{
    ...
    [HttpGet("user/access-token")]
    public async Task<IActionResult> GetUserAccessToken(CancellationToken cancellationToken)
    {
        var response = await Mediator.Send(new GetUserAccessTokenQuery(), cancellationToken);
